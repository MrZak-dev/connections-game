...
class ConnectionsGame {
    ...
    private addEventListeners() {
        ...
        document.querySelector('[data-testid="help-button-success"]')?.addEventListener('click', () => this.toggleHowToPlayModal());
        document.querySelector('[data-testid="menu-button-failure"]')?.addEventListener('click', () => this.toggleMenu());
        document.querySelector('[data-testid="help-button-failure"]')?.addEventListener('click', () => this.toggleHowToPlayModal());
